--parasite Generator
--scripted by CyberCatMan- Fixed by GameMaster (GM)
function c511009347.initial_effect(c)
	...
	c:RegisterEffect(e4)
	--Global check
if not c511009347.gl_chk then
		c511009347.gl_chk=true
		local ge1=Effect.GlobalEffect()
		ge1:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_CONTINUOUS)
		ge1:SetCode(EVENT_SPSUMMON_SUCCESS)
		ge1:SetOperation(c511009347.regop)
...
function c511009347.regop(e,tp,eg,ep,ev,re,r,rp)
