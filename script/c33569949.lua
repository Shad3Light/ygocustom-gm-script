...
function c33569949.initial_effect(c)
	--ATK/DEF dOWN 500
	...
	e1:SetCondition(c33569949.condition)
	e1:SetOperation(c33569949.operation)
	c:RegisterEffect(e1)
end

function c33569949.condition(e,tp,eg,ep,ev,re,r,rp)
...
function c33569949.operation(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
